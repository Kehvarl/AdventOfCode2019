...
prog = [3, 26, 1001, 26, -4, 26, 3, 27, 1002, 27, 2, 27, 1, 27, 26, 27, 4, 27, 1001, 28, -1, 28, 1005, 28, 6, 99, 0, 0,
        5]
...
def run_permutation(permutation):
    ...
    for a in permutation:
        ...
        comp.run()
        signal = comp.output
        # comp.input_val.append(int(signal))
...
print(int(run_permutation([9, 7, 8, 5, 6])))
